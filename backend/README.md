...
## Project Structure
    ...
    ├── testapiautocatalog_116936  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116936`
...
2. Clone this repo and `cd testapiautocatalog_116936`
